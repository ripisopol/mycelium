...
const STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .search-results { position: absolute; top: calc(100% + 4px); left: 0; right: 0; background: var(--bg2); border: 1px solid var(--border); border-radius: 3px; z-index: 200; overflow: hidden; }
    ...
    <>
      ...
      <div className="shell">
        ...
        <header className="topbar">
          <div className="topbar-logo">mycelium<span>.kb</span></div>
